...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
                            ...
                            reply_markup=InlineKeyboardMarkup(
                                [
                                    ...
                                    [
                                        InlineKeyboardButton(
                                            "⚜️ ᴜᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ 🔱",
                                            url="https://t.me/All_language_movie_abot",
                                        )
                                    ],
                                ]
                            ),
        ...
        await client.send_cached_media(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(
                            "⚜️ ᴜᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ 🔱", url="https://t.me/All_language_movie_abot"
                        )
                    ],
                ]
            ),
    ...
    elif query.data.startswith("killfilesAll_language_movie_abot"):
        ...
        btn = [
            [
                ...
                InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/All_language_movie_abot"),
            ]
        ]
        await client.edit_message_media(
            query.message.chat.id,
